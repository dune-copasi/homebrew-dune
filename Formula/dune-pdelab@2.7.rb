class DunePdelabAT27 < Formula
  ...
  if build.with? "support-dune-copasi-v0.3"
    ...
    depends_on "dune-copasi/tap/dune-localfunctions@2.7" => "with-support-dune-copasi-v0.3"
  else
    opoo "Plain dune-pdelab v2.7 installation is broken. Try with --with-support-dune-copasi-v0.3 flag."
