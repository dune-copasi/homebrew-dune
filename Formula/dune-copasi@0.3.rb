class DuneCopasiAT03 < Formula
  ...
  depends_on "dune-copasi/tap/dune-pdelab@2.7" => "with-support-dune-copasi-v0.3"
  depends_on "dune-copasi/tap/dune-logging@2.7" => "with-support-dune-copasi-v0.3"
  depends_on "dune-copasi/tap/dune-multidomaingrid@2.7" => "with-support-dune-copasi-v0.3"
